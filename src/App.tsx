                  ...
                  <div className="relative">
                    ...
                    {activeTxDropdown === 'timeframe' && (
                      <>
                        ...
                        <div 
                          className="fixed inset-0 bg-slate-900/40 z-15 lg:hidden"
                          onClick={() => setActiveTxDropdown(null)}
                        />
                        <div className="fixed inset-x-4 top-[35%] md:left-1/2 md:-translate-x-1/2 md:w-48 lg:absolute lg:inset-auto lg:left-0 lg:translate-x-0 lg:mt-2 w-auto bg-white border border-slate-200 rounded-xl shadow-lg py-1.5 z-20 animate-in fade-in slide-in-from-top-1 duration-150">
                          {(['All Time', 'This Month', 'This Week', 'Today'] as const).map((time) => (
                            <button
                              ...
                              className={`w-full text-left px-4 py-2.5 text-xs font-semibold hover:bg-slate-50 transition-colors cursor-pointer ${
                    ...
                    {activeTxDropdown === 'category' && (
                      <>
                        ...
                        <div 
                          ...
                          onClick={() => setActiveTxDropdown(null)}
                        />
                        <div className="fixed inset-x-4 top-[20%] md:left-1/2 md:-translate-x-1/2 md:w-80 lg:absolute lg:inset-auto lg:left-0 lg:translate-x-0 lg:mt-2 w-auto bg-white border border-slate-200 rounded-2xl shadow-xl py-2.5 z-20 animate-in fade-in slide-in-from-top-1 duration-150 flex flex-col gap-1.5 px-3">
                                  ...
                                  <>
                                    ...
                                    <div className="flex items-center gap-1 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity" onClick={(e) => e.stopPropagation()}>
                                      <button
                                        ...
                                        className="p-1 rounded-md hover:bg-slate-200/60 text-slate-400 hover:text-slate-700 transition-colors cursor-pointer border-0"
                                        title="Edit category"
                                      >
                                      ...
                                      <button
                                        ...
                                        className="p-1.5 rounded-lg hover:bg-rose-50 text-rose-500 hover:text-rose-700 transition-colors cursor-pointer border-0 flex items-center gap-1"
                                        title="Delete category"
                                      >
                                        <Trash2 className="w-3.5 h-3.5" />
                                        <span className="text-[10px] font-bold uppercase tracking-wider lg:hidden">Delete</span>
                                      </button>
                                    </div>
                                  </>
                                )}
